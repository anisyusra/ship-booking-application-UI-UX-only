...
import 'package:project_mobile/models/value/value_db.dart';
...
class ValueGame extends StatefulWidget {
  const ValueGame({super.key});

  @override
  State<ValueGame> createState() => _ValueGameState();
}

class _ValueGameState extends State<ValueGame> {
  //create and object for Dbconnect
  var db = ValueDBconnect();
